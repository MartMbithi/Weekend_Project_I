...
if (isset($_POST['Reset_Password'])) {
    ...
    /* Check If Checksums & Hash Digest Match */
    if ($confirm_password != $new_password) {
        ...
        $bind = $prepare->bind_param('ss', $confirm_password, $admin_email);
        $prepare->execute();
        if ($prepare) {
            $success = "Password Updated" && header("refresh:1 url=index");
        } else {
    ...
    <div class="login-box">
        ...
        <div class="card">
            <div class="card-body login-card-body">
                <p class="login-box-msg">Confirm Passwords </p>
