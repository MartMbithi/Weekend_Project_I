...
<div class="nav-header">
    <a href="client_home" class="brand-logo">
                        ...
                        <div class="dropdown-menu rounded dropdown-menu-right">
                            <div id="DZ_W_Notification1" class="widget-media dz-scroll p-3 height380">
                                <ul class="timeline">
                                    ...
                                    $ret = "SELECT * FROM notifications WHERE notification_client_id = '$client_id'
                                        ...
                                        <li>
                                            <div class="timeline-panel">
                                                ...
                                                <div class="media-body">
                                                    <p class="mb-1">
                                                        <?php echo $notification->notification_details; ?>
                                                    </p>
                                                    <small class="d-block"><?php echo date('d M Y - g:ia', strtotime($notification->notification_created_at)); ?></small>
                                                </div>
                                            </div>
                                        </li>
                                    <?php } ?>
                            ...
                            <a class="all-notification" href="client_home?clear=<?php echo $client_id; ?>">Clear All Notifications<i class="ti-trash"></i></a>
                        </div>
                    </li>
                    <li class="nav-item dropdown header-profile">
                        <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                            <img src="../public/backend_assets/images/avatar/no-profile.png" width="20" alt="" />
                        </a>
                        <div class="dropdown-menu dropdown-menu-right">
                            <a href="client_profile" class="dropdown-item ai-icon">
                            ...
                            <a href="client_logout" class="dropdown-item ai-icon">
